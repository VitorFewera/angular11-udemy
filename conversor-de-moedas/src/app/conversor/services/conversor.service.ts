...
export class ConversorService {
  ...
  converter(conversao: Conversao): Observable<any> {
              // & chamando parametro
  let params = `&base=${conversao.moedaDe}&symbols=${conversao.moedaPara}`; //chamo o parametro &base e &symbols
  // chama o serviço que importou da api
  return this.http
      .get(this.BASE_URL + params); // obtenha uma informação da URL
